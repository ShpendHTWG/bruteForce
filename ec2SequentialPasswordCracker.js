...
const { crackPasswordWithSequentialAlgorithmInEc2 } = require('./bin/ec2');
...
async function main() {
    const result = await crackPasswordWithSequentialAlgorithmInEc2(alphabet, passwordHash, passwordLength, startTime);
